...
#ВЫберем данные нужного нам года, добавим колонки year, month для группировки
...
# Вычислим средие активные температуры за месяц со всех метеостанций, для этого сначала сгруппируем по месяцам
group_by(month) %>%
